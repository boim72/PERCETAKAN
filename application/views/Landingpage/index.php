...
-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('assets/landingpage/assets') ?>/css/bootstrap.min.css">
...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="<?= base_url() ?>Auth/login">login</li>
    ...
    <!-- jQuery -->
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/jquery-2.1.0.min.js"></script>

    <!-- Bootstrap -->
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/popper.js"></script>
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/bootstrap.min.js"></script>

    <!-- Plugins -->
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/owl-carousel.js"></script>
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/scrollreveal.min.js"></script>
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/waypoints.min.js"></script>
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/jquery.counterup.min.js"></script>
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/imgfix.min.js"></script>

    <!-- Global Init -->
    <script src="<?php echo base_url('assets/landingpage/assets') ?>/js/custom.js"></script>
