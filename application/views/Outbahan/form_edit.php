		...
		<div class='col-xs-10'>
			<div class='box box-primary'>
				<div class='box-header  with-border'>
					<h3 class='box-title'>Edit Data Bahan Keluar</h3>
				</div>
				<div class="box-body">
					<?php echo form_open_multipart('outbahan/edit', array('role' => "form", 'id_outbahan' => "myForm", 'data-toggle' => "validator")); ?>
					<div class="form-group">
						<label for="out_tanggal" class="control-label">Tanggal Keluar</label>
						<div class="input-group date">
							<input type="date" class="form-control" name="out_tanggal" id="out_tanggal" data-error="tanggal harus diisi" placeholder="date" value="<?php echo $record['out_tanggal']; ?>" required />
					...
					<div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" name="out_jumlah" id="out_jumlah" data-error="jumlah harus diisi" placeholder="jumlah" value="<?php echo $record['out_jumlah']; ?>" required />
                            <span class="input-group-addon">
                                <span class="fa fa-cube"></span>
                            </span>
                        </div>
					...
					<div class="box-footer">
						<input type="hidden" name="id_outbahan" value="<?php echo $record['id_outbahan'] ?>">
...
<script>
    ...
    // Set nilai jumlah tersedia saat halaman dimuat
    var id_bahan = $('#id_bahan_select').val();
    $.ajax({
        url: '<?php echo base_url() ?>outbahan/get_jumlah_bahan',
        type: 'post',
        data: {
