					...
					<div class="box-body">
						<table id="myTable" class="table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									<td><?php echo $no++; ?></td>
									<td><?php echo $user->nama_operator ?></td>
									<td><?php echo $user->username ?></td>
									<td>
										<a href="<?php echo (site_url('uploads/operator/' . $user->foto)); ?>" class="image-link">
											<img src="<?php echo (site_url('uploads/operator/' . $user->foto)); ?>" alt="" style="width:30px;height:30px">
										</a>
									</td>
									<td>
										<?php
											echo anchor(site_url('operator/edit/' . $user->id_operator), '<i class="fa fa-pencil-square-o fa-lg"></i>&nbsp;&nbsp;Edit', array('title' => 'edit', 'class' => 'btn btn-sm btn-warning'));
											echo '&nbsp';
											?>
									</td>
								</tr>
