...
<section class="content">
	<div class="container">
			...
			<ul class="nav nav-pills">
				<li class="nav-item <?= uri_string() === 'barangOffline/index' ? 'active' : '' ?>">
					<a href="<?= base_url('barangOffline/index') ?>" class="nav-link">Table Pesanan</a>
				</li>
				<li class="nav-item <?= uri_string() === 'barangOffline/index_card' ? 'active' : '' ?>">
					<a href="<?= base_url('barangOffline/index_card') ?>" class="nav-link">Card Pesanan</a>
				</li>
			</ul>
			</header>
		</div>
			...
			<div class="box box-info">
				<div class='box-header with-border'>
					...
					<div class="pull-right">
						<?php
						echo anchor('BarangOffline/post', 'Tambah data', array('class' => 'btn btn-success'))
						?>
					</div>
				</div>
					<div class="box-body">
						<table id="myTable" class="table table-bordered table-hover ">
							...
							<tbody>
								...
								<tr>
									...
									<td><span class="badge text-bg-primary"><?php echo $r->tanggal_barang; ?></span></td>
									<td>
