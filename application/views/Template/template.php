...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
			...
			<section class="sidebar">
				...
				<?php if ($this->session->userdata('akses') == 1 ) : ?>
					<ul class="sidebar-menu" data-widget="tree">
						...
						<li class="active treeview">
							<a href="#">
								<i class="fa fa-dropbox"></i> <span>Manage Bahan</span>
								<span class="pull-right-container">
									<i class="fa fa-angle-left pull-right-container"></i>
								</span>
							</a>
							<ul class="treeview-menu">
								<li class="active"><a href="<?= base_url() ?>index.php/Inbahan"><i class="fa fa-arrow-circle-right "></i>Bahan Masuk</a></li>
						...
						<!-- <li>
							<a href="<php echo base_url() ?>index.php/aset">
								<i class="fa fa-shopping-cart"></i> <span>ASET</span>
								<span class="pull-right-container">
								</span>
							</a>
						</li> -->
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2024 <a href="#">Bina Coding</a>.</strong> All rights
			reserved.
		</footer>
		<!-- /.control-sidebar -->
